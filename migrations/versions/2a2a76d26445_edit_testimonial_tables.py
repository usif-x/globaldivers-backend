"""edit_testimonial_tables

Revision ID: 2a2a76d26445
Revises: 4e619eeffb14
Create Date: 2025-12-20 12:57:08.917365
...
revision: str = "2a2a76d26445"
down_revision: Union[str, Sequence[str], None] = "4e619eeffb14"
...
def upgrade() -> None:
    ...
    op.add_column(
        "testimonials", sa.Column("notes", sa.String(length=500), nullable=True)
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("testimonials", "notes")
    op.create_table(
        "best_selling",
        ...
        sa.ForeignKeyConstraint(
            ["course_id"], ["courses.id"], name=op.f("best_selling_course_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["trip_id"], ["trips.id"], name=op.f("best_selling_trip_id_fkey")
        ),
