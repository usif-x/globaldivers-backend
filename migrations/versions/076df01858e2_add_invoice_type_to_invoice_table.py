"""Add invoice_type to Invoice table

Revision ID: 076df01858e2
Revises: a7f95de8aaba
Create Date: 2025-10-24 17:15:04.748339
...
revision: str = "076df01858e2"
down_revision: Union[str, Sequence[str], None] = "a7f95de8aaba"
...
def upgrade() -> None:
    ...
    op.drop_index("ix_gallery_id", table_name="gallery")
    op.drop_index("ix_gallery_name", table_name="gallery")
    op.drop_table("gallery")

    # Add invoice_type column as nullable first
    op.add_column(
        "invoices", sa.Column("invoice_type", sa.String(length=20), nullable=True)
    )

    # Set default value for existing records
    op.execute("UPDATE invoices SET invoice_type = 'online' WHERE invoice_type IS NULL")

    # Now make it NOT NULL with default
    op.alter_column("invoices", "invoice_type", nullable=False, server_default="online")
