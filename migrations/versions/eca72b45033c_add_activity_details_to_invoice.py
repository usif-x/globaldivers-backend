...
def upgrade() -> None:
    ...
    op.add_column('invoices', sa.Column('activity_details', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], name='best_selling_course_id_fkey'),
    sa.ForeignKeyConstraint(['trip_id'], ['trips.id'], name='best_selling_trip_id_fkey'),
