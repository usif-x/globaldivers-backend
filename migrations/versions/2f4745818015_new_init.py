...
Revision ID: 2f4745818015
Revises: 7b5a5fee60fc
Create Date: 2025-10-25 15:22:21.333446
...
revision: str = '2f4745818015'
down_revision: Union[str, Sequence[str], None] = '7b5a5fee60fc'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('invoices', sa.Column('invoice_type', sa.VARCHAR(length=20), server_default=sa.text("'online'::character varying"), autoincrement=False, nullable=False))
