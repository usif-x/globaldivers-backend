...
class Admin(Base):
  ...
  role: Mapped[str] = mapped_column(String(40),nullable=False, server_default="admin")
  admin_level: Mapped[int] = mapped_column(String(40),nullable=False, server_default="1")
