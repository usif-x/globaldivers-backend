...
from sqlalchemy import String, Float, Boolean, Integer, JSON, text, DateTime
...
class Trip(Base):
  ...
  has_discount: Mapped[bool] = mapped_column(Boolean, nullable=True, server_default=text("0"))
  discount_percentage: Mapped[int] = mapped_column(Integer, nullable=True)
  duration: Mapped[int] = mapped_column(Integer, nullable=False, server_default=text("8"))
